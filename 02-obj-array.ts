...
//enum Role { ADMIN = 'ADMIN', READ_ONLY = 100, AUTHOR = 200 } // 직접 값을 할당해줄 수도 있음 
const person3 = {
	name: '유소희',
	age: 10,
	hobbies: ['독서','운동'],
...
if (person3.role === Role.ADMIN) {
	console.log('amdin 맞음')
} else {
	console.log('amdin 아님')
}

// any type
// 타입이 혼합된 배열 (그래서 바닐라랑 똑같음)
// 어떤 값이나 종류의 데이터가 어디에 저장될지 알 수 없는 경우를 대비하는 것 외에는 안쓰는게 좋음
let hobbiesArr: any[];
hobbiesArr = ['독서', 3, '운동'];
